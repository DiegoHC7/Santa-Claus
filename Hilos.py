...
# Mutex
mutex = threading.Lock()  # Mutex para proteger el acceso a la variable de conteo de renos
renos_listos = 0  # Variable compartida para contar renos listos
...
while True:
    ...
    sem_taller.acquire()  # Esperar a que un duende termine su trabajo para liberar espacio en el talle
